...
public class CmlKeywords implements IVdmKeywords
  {
    
    public static final String[] reservedwords         = { "#act", "#active",
        "#fin", "#req", "#waiting", "abs", "all", "always", "and", "async",
        "atomic",
        /* "be", */"bool", "by", "card", "cases", "char", "class", "comp",
        "compose", "conc", "dcl", "def", "dinter", "div", "do", "dom",
        "dunion", "elems", "else", "elseif", /* "error", */"errs", "exists",
        "exists1", "exit", /* "ext", */"false", "floor", "for", "forall",
        ...
        "mu", "munion", "mutex", "nat", "nat1", "new", "nil", "not", "of",
        "operations", "or", "others", "per", "periodic", "post", "power",
        "pre", "private", "protected", "psubset", "public", "rat", "rd",
        "real", "rem", /* "responsibility", */"return", "reverse", "rng",
        "samebaseclass", "sameclass", "self", "seq", "seq1", "set", "Skip", /*
                                                                             * "specified"
                                                                             * ,
                                                                             *//*
                                                                                * "st"
                                                                                * ,
                                                                                */
        "static", "start", "startlist", "subclass", "subset", "sync", "then",
        "thread", "threadid", "tixe", "tl", "to", "token", "traces", "trap",
        "true", "types", "undefined", "union", "values", "variables", "while",
        "with", "wr", /* "yet", */"RESULT",
        // CML Specific
        "actions", "begin", "chansets", "channels", "end", "frame", "process",
        "state", "Stop", "Chaos", "Wait"              
                                                       
                                                       };
    
    public static final String[] multipleKeywords      = {
        "is not yet specified", "for all", "in set", "be st", "not in set",
        "is subclass of", "instance variables", "is subclass responsibility" };
    
    public static String[]       historyCounters       = { "#act", "#fin",
        "#active", "#req", "#waiting"                 };
    ...
    public static final String[] basictypes            = { "bool", "int",
        "nat", "nat1", "real", "rat", "char", "token" };
    
    public static final String[] textvalues            = { "true", "false",
        "nil"                                         };
    
    public static final String[] unaryoperators        = { "abs", "card",
        "floor", "hd", "tl", "len", "elems", "inds", "conc", "dom", "rng",
        "merge", "not", "inverse", "dunion", "dinter", "power",
        "isofbaseclass", "isofclass", "samebaseclass", "sameclass" };
    ...
    public String[] getAllSingleWordKeywords()
      {
        int offset = 0;
        String[] all = new String[basictypes.length + binaryoperators.length
        // + multipleKeywords.length
            + reservedwords.length + textvalues.length + unaryoperators.length];
        
        System.arraycopy(basictypes, 0, all, offset, basictypes.length);
        offset = offset + basictypes.length;
        
        System.arraycopy(binaryoperators, 0, all, offset,
            binaryoperators.length);
        offset = offset + binaryoperators.length;
        
        // System.arraycopy(multipleKeywords, 0, all, offset,
        // multipleKeywords.length);
