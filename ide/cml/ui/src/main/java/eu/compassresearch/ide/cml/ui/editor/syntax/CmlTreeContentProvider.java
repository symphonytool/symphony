...
public class CmlTreeContentProvider implements ITreeContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		try {
			...
			if (n instanceof Wrapper) {
				...
				// if (w.isClass(AProcessParagraphDefinition.class)) {
				// AProcessParagraphDefinition processDecl =
				// (AProcessParagraphDefinition) w.value;
				...
				// (ASequentialCompositionProcess) w.value;
	...
	// ASequentialCompositionProcess p = (ASequentialCompositionProcess)
	// process;
