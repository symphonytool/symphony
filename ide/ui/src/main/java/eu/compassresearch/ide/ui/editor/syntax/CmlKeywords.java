...
public class CmlKeywords implements IVdmKeywords
{
	...
	public static final String[] reservedwords = { "#act", "#active", "#fin",
			...
			"rng", "samebaseclass", "sameclass", "self", "seq", "seq1", "set",
			"Skip", /*
					 * "specified" ,
					 *//*
						 * "st" ,
						 */
			"static", "start", "startlist", "subclass", "subset", "sync",
			"then", "thread", "threadid", "tixe", "tl", "to", "token",
			"traces", "trap", "true", "types", "undefined", "union", "values",
	...
	public static String[] historyCounters = { "#act", "#fin", "#active",
			"#req", "#waiting" };
	...
	public static final String[] unaryoperators = { "abs", "card", "floor",
			...
			"not", "inverse", "dunion", "dinter", "power", "isofbaseclass",
			"isofclass", "samebaseclass", "sameclass" };
	...
	public String[] getAllSingleWordKeywords()
	{
		...
		String[] all = new String[basictypes.length + binaryoperators.length
				...
				+ reservedwords.length + textvalues.length
