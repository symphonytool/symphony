...
import eu.compassresearch.ide.ui.editor.syntax.CmlCodeScanner;
...
public class CmlSourceViewerConfiguration extends VdmSourceViewerConfiguration
{
			...
			ISourceViewer sourceViewer)
	{
		if (assistant == null)
		{
			...
			assistant.setContentAssistProcessor(new CmlContentAssistProcessor(), IDocument.DEFAULT_CONTENT_TYPE);
