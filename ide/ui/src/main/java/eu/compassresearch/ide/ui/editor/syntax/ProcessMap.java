...
public class ProcessMap
{
	...
	private static Map<Class<?>, ? extends ProcessHandler> createMap()
	{
		...
		map.put(AAlphabetisedParallelismProcess.class, new AAlphabetisedParallelismProcessHandler());
		map.put(AAlphabetisedParallelismReplicatedProcess.class, new AAlphabetisedParallelismReplicatedProcessHandler());
		map.put(AChannelRenamingProcess.class, new AChannelRenamingProcessHandler());
		...
		map.put(AExternalChoiceReplicatedProcess.class, new AExternalChoiceReplicatedProcessHandler());
		map.put(AGeneralisedParallelismProcess.class, new AGeneralisedParallelismProcessHandler());
		map.put(AGeneralisedParallelismReplicatedProcess.class, new AGeneralisedParallelismReplicatedProcessHandler());
		...
		map.put(AInterleavingReplicatedProcess.class, new AInterleavingReplicatedProcessHandler());
		map.put(AInternalChoiceProcess.class, new AInternalChoiceProcessHandler());
		map.put(AInternalChoiceReplicatedProcess.class, new AInternalChoiceReplicatedProcessHandler());
		...
		map.put(ASequentialCompositionProcess.class, new ASequentialCompositionProcessHandler());
		map.put(ASequentialCompositionReplicatedProcess.class, new ASequentialCompositionReplicatedProcessHandler());
		...
		map.put(ASynchronousParallelismReplicatedProcess.class, new ASynchronousParallelismReplicatedProcessHandler());
		map.put(ATimedInterruptProcess.class, new ATimedInterruptProcessHandler());
		map.put(ATimeoutProcess.class, new ATimeoutProcessHandler());
		map.put(AUntimedTimeoutProcess.class, new AUntimedTimeoutProcessHandler());
