...
public interface ICmlDebugConstants
{
	...
	public final String CML_LAUNCH_CONFIG_COSIM_MININT = "CML_LAUNCH_CONFIG_COSIM_MININT".toLowerCase();
	public final String CML_LAUNCH_CONFIG_COSIM_MAXINT = "CML_LAUNCH_CONFIG_COSIM_MAXINT".toLowerCase();
