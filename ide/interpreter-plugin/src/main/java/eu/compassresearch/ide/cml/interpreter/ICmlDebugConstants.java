...
public interface ICmlDebugConstants {
	...
	public final String ATTR_LAUNCH_CONFIGURATION_TYPE = "eu.compassresearch.ide.cml.interpreter.launchConfigurationType";
	public final String ATTR_DEBUGGER_CONFIG_PARAMS = "eu.compassresearch.ide.cml.interpreter.debugger_config_params";
