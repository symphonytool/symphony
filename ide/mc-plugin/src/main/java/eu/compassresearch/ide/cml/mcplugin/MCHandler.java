					...
					if (selection instanceof IStructuredSelection) {
					    ...
					    if (cmlFile != null) {
					        if("cml".equalsIgnoreCase(cmlFile.getFileExtension())){
					    		...
					    		//		window.getShell(),
					    		//		"Test command",
					    		//		"Model checker will analyse " + event.getParameter("eu.compassresearch.ide.cml.mcplugin.property") + " for " + cmlFile.getLocation().toFile().getAbsolutePath());
					        	String propertyToCheck = this.getProperty(event.getParameter("eu.compassresearch.ide.cml.mcplugin.property"));
