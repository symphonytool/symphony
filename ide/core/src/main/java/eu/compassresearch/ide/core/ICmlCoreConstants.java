...
public interface ICmlCoreConstants
{
	...
	public static final String BUILDER_ID = PLUGIN_ID + ".cmlbuilder";
	// public static final String LAUNCH_CONFIGURATION_TYPE_VDMRT_VDMJ =
	// "org.overture.ide.vdmrt.debug.core.launchConfigurationTypeVDMJ";
