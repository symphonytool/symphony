...
public class InterpretAllCmlFilesTest {
	...
	public TestWatcher watchman = new TestWatcher() {
		...
		protected void failed(Throwable e, Description d) {
			...
			System.out.println("Test failed in : "+ d.getMethodName() + " : " + filePath );
		 ...
		 protected void succeeded(Description d) {
			 ...
			 System.out.println(d.getMethodName() + " : '" + filePath + "' completed succesfully");
		 }
	};
	...
	{
		assertTrue(testResult.getVisibleTrace().equals(status.getVisibleTrace()));
