...
public class ChannelNameValue extends Value {
	...
	private Value meet(Value val1, Value val2)
	{
		...
		if(AbstractValueInterpreter.isValueMostPrecise(val1) && AbstractValueInterpreter.isValueMostPrecise(val2))
			return val1;
		else if(!AbstractValueInterpreter.isValueMostPrecise(val1) && !AbstractValueInterpreter.isValueMostPrecise(val2))
		{
