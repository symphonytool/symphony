...
public enum InterpretationErrorMessages
{
	...
	NO_PROCESS_WITH_DEFINED_NAME_FOUND("No process identified by '%s' exists"), FATAL_ERROR(
			"A fatal unrecoverable error has occured, please report this error to akm@iha.dk"), CASE_NOT_IMPLEMENTED(
