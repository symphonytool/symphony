...
public enum InterpretationErrorMessages
{
	...
	EVAL_OF_UNDEFINED_VALUE(
			"You are trying to evaluate an undefined value : %s %s"),

	EVAL_OF_IMPLICIT_OP(
			"The operation '%s' is implicit, this is not possible to interpret"),

	SYNC_OF_NONCOMPARABLE_EVENTS(
