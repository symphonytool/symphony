...
//import eu.compassresearch.core.interpreter.CmlStatementEvaluationVisitor;
//import eu.compassresearch.core.interpreter.ConcreteCmlBehaviour;
//import eu.compassresearch.core.interpreter.ReplicatedActionEvaluationVisitor;
...
// *
// */
//class ActionEvaluationVisitor extends CommonEvaluationVisitor {
//
//	/**
//	 * 
//	 */
...
//	
//	private final QuestionAnswerCMLAdaptor<Context, Pair<INode, Context>> statementEvalVisitor;
//	private final QuestionAnswerCMLAdaptor<Context, Pair<INode, Context>> replicatedActionEvalVisitor;
//	
...
//		replicatedActionEvalVisitor = new ReplicatedActionEvaluationVisitor(parentVisitor, owner, visitorAccess);
//	}
//		
//	/**
//	 * Transition methods
...
//	
//	@Override
//	public Pair<INode, Context> defaultSReplicatedAction(
//			SReplicatedAction node, Context question) throws AnalysisException {
//
//		return node.apply(replicatedActionEvalVisitor,question);
//	}
//	
//	@Override
