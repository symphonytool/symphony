...
//import eu.compassresearch.core.interpreter.CmlDefinitionVisitor;
...
//
//abstract class AbstractEvaluationVisitor extends QuestionAnswerCMLAdaptor<Context, Pair<INode, Context>> {
//
//	/**
