...
{
	/*
	 * We need to override this case since overture expects the name of
	 * an AIdentifierStateDesignator to contain the module (this is added by the vdm SyntaxReader l352)
	 * of the containing class. This is not added by the cml parser so we need to remove the
	 * explicit true to be able to find in the vdm intepreter
	 */
	@Override
