...
public class MCATimedInterruptProcess extends MCAInterruptProcess {

	private MCPCMLExp timeExpression;
	
	public MCATimedInterruptProcess(MCPProcess left, MCPProcess right, MCPCMLExp timeExpression) {
		super(left, right);
