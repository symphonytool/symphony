...
//	private final AExplicitFunctionDefinition postexp;
	...
	public CmlSatisfiabilityObligation(AImplicitFunctionDefinition func, IPOContextStack ctxt) throws AnalysisException
	{
...
//			valuetree.setContext(ctxt.getContextNodeList());
			...
			PDefinition stateDefinition, IPOContextStack ctxt) throws AnalysisException
	{
		...
		if (res.size() == 1 & res.getFirst().getPattern() instanceof AIdentifierPattern)	
