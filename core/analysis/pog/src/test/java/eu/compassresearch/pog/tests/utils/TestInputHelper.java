...
/**
 * Helper Class for the POG test framework. Helps generate test inputs. This classes I/O and interaction with the
 * COMPASS TC and Parser.
 * 
 * @author ldc
 */
...
{
	/**
	 * Main helper method. Take a file name and runs it through the COMPASS parser and typechecker. Also causes a test
	 * failure if the model cannot be analyzed. <br>
	 * <br>
	 ...
	 * @throws IOException
	 *             file could not be found or some other I/O error.
	 */
