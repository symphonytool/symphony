		...
		AbstractResultBasedCmlTypeCheckerTestCase
{
	...
	{
		return combine(collectResourcesTestData("namesets", TestType.POSITIVE, TestType.COMPARE_RECORDRD), collectResourcesTestData("namesets", TestType.NEGATIVE, TestType.NEGATIVE));
	}
