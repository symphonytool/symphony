...
public class CmlTypeCheckerTestCase extends TestCase
  {
    ...
    public static Collection<Object[]> parameter()
      {
        ...
        addTestProgram(testData,
            ...
            true, true); // bool literal
        addTestProgram(testData,
            "class test = begin values public a:nat = 1 end", false, true, true); // nat
                                                                                  // literal
        addTestProgram(testData,
            "class test = begin values public a:nat1 = 1 end", false, true,
            true); // nat1 literal
        addTestProgram(testData,
            "class test = begin values public a:rat = 0.12 end", false, true,
            true); // rat literal
        addTestProgram(testData,
        ...
        addTestProgram(
            ...
            false, true, true); // token literal
        addTestProgram(testData,
            "class test = begin values public a:int = 1.25E+10  end", false,
            true, true); // Exponent literal
        // 10
        addTestProgram(testData,
            "class test = begin values public a:int = 1.25E-10  end", false,
            true, true); // token literal
        addTestProgram(testData,
            "class test = begin values public a:int = 1.25e+10  end", false,
            true, true); // token literal
        addTestProgram(testData,
        ...
        addTestProgram(testData,
            "class test = begin values a:int = abs -42 end ", false, true, true);
        addTestProgram(testData,
    ...
    public CmlTypeCheckerTestCase(String cmlSource, boolean postM12,
        boolean parsesOk, boolean typesOk)
      {
