		...
		AbstractResultBasedCmlTypeCheckerTestCase
{
	...
	{
		return combine(collectResourcesTestData("values", TestType.POSITIVE, TestType.COMPARE_RECORDRD), collectResourcesTestData("values", TestType.NEGATIVE, TestType.COMPARE_RECORDRD));
	}
