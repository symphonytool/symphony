		...
		AbstractTypeCheckerTestCase
{
	...
	static
	{
		...
		// 4//
		add("class test = begin operations o:int ==> int o(a) == (return (let a : int = 2 in \"42\")) end", true, false);
		// 5//
		...
		add("class t = begin types A :: a : int operations o:A==>int o(b) == return b.a pre b.a > 0 post b.a = b~.a and 'b.a' = b~.a end", true, false);
		// 11// op-call
