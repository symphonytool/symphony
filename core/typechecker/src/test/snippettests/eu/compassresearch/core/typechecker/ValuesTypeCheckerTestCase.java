...
public class ValuesTypeCheckerTestCase extends AbstractTypeCheckerTestCase{
	static {
		...
		//10//
		add("class test = begin values public a:real = 1.25E-10  end"); // token literal
		//11//
		add("class test = begin values public a:real = 1.25e+10  end"); // token literal
		//12//
		add("class test = begin values public a:real = 1.25e-10  end"); // token literal
		//13//
		add("class test = begin values public a:int = 0xDEADBEEF + 0xCAFEBABE end"); // token literal
		//14//
		...
		//25//
		add("class test = begin values public a:char = '\\cc' end"); 
		//26//
		add("class test = begin values public a:char = '\\\"' end"); 
		//27//
		...
		//111//
		add("class test = begin values one:test = self end", true, true,
				 new String[] { "self not in scope.", "Paragraph \"test\" has type errors." });
		//112//
		add("class test = begin values one:bool = is_test ( self ) end",
				 true, false, new String[] {"self not in scope.","Paragraph \"test\" has type errors."});
		// 113//
		add("class test = begin values one:bool = is_(self, test) end");
		// 114//
