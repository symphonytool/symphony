...
public enum TypeErrorMessages
{
	...
	EXPECTING_A_CHANNEL_OR_CHANSET_DEFINITION(3441,
			"Expecting a channel or chanset definition but found a %s definition"),

	EXPECTED_STATE_OR_NAMESET_DEFINITION(3442,
	...
	UNSUPPORTED_CONSTRUCT(3444,
			"Unsupported language construct found: '%s'");
