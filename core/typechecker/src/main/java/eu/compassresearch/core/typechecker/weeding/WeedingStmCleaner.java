...
//		if ((grandParent instanceof PStm || grandParent instanceof ACaseAlternativeStm || grandParent instanceof SOperationDefinition)&&node.parent() instanceof AActionStm)
//		{
