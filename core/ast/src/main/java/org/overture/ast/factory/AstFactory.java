...
public class AstFactory {
	...
	public static AImplicitOperationDefinition newAImplicitOperationDefinition(
		...
		AOperationType operationType = AstFactory.newAOperationType(
				...
				(result.getResult() == null ? AstFactory
						.newAVoidType(name.location) : result.getResult()
						.getType()));
	...
	public static AExternalClause newAExternalClause(LexToken mode,
		...
		result.setType((type == null) ? AstFactory.newAUnknownType(names.get(0).location)
				: type);
	...
	public static ALetBeStBindingTraceDefinition newALetBeStBindingTraceDefinition(
			...
			PTraceDefinition body) {
		return new ALetBeStBindingTraceDefinition(location, bind, stexp, body,
				null);
	}
	...
	public static ACallObjectStm newACallObjectStm(
			PObjectDesignator designator, LexNameToken classname,
			List<PExp> args) {
