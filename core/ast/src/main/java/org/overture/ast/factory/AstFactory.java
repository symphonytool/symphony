...
public class AstFactory
  {
    ...
    /*
     * Init Methods - correspond to constructors of the abstract classes, e.g.
     * Definition, Pattern, Type, etc.
     */
    private static void initPattern(PPattern result, LexLocation location)
      {
    ...
    protected static void initClassDefinition(SClassDefinition result,
        ...
        List<PDefinition> members)
      {
        initDefinition(result, Pass.DEFS, className.location, className,
            NameScope.CLASSNAME);
        ...
        PDefinitionAssistant
            .setClassDefinition(result.getDefinitions(), result);
    ...
    public static ATypeDefinition newATypeDefinition(LexNameToken name,
        SInvariantType type, PPattern invPattern, PExp invExpression)
      {
        ...
        initDefinition(result, Pass.TYPES, name.location, name,
            NameScope.TYPENAME);
    ...
    public static AExplicitFunctionDefinition newAExplicitFunctionDefinition(
        LexNameToken name, NameScope scope, List<LexNameToken> typeParams,
        AFunctionType type, List<List<PPattern>> parameters, PExp body,
        PExp precondition, PExp postcondition, boolean typeInvariant,
    ...
    public static AImplicitFunctionDefinition newAImplicitFunctionDefinition(
        ...
        PExp postcondition, LexNameToken measure)
      {
        ...
        AFunctionType type = AstFactory.newAFunctionType(result.getLocation(),
            false, ptypes, resultPattern.getType());// AFunctionType(funcName.location,
                                                    // false, null, false,
                                                    // ptypes, (PType)
    ...
    public static AStateDefinition newAStateDefinition(LexNameToken name,
        ...
        PPattern initPattern, PExp initExpression)
      {
        ...
        for (AFieldField f : fields)
          {
            stateDefs.add(AstFactory.newALocalDefinition(
                f.getTagname().location, f.getTagname(), NameScope.STATE,
                f.getType()));
            ALocalDefinition ld = AstFactory.newALocalDefinition(
                f.getTagname().location, f.getTagname().getOldName(),
                NameScope.OLDSTATE, f.getType());
            
            ld.setUsed(true); // Else we moan about unused ~x names
            stateDefs.add(ld);
          }
        
        result.setRecordType(AstFactory.newARecordInvariantType(name.clone(),
            fields));
        
        ALocalDefinition recordDefinition = null;
        
        recordDefinition = AstFactory.newALocalDefinition(result.getLocation(),
            name, NameScope.STATE, result.getRecordType());
        recordDefinition.setUsed(true); // Can't be exported anyway
        stateDefs.add(recordDefinition);
        
        recordDefinition = AstFactory.newALocalDefinition(result.getLocation(),
            name.getOldName(), NameScope.OLDSTATE, result.getRecordType());
        recordDefinition.setUsed(true); // Can't be exported anyway
        stateDefs.add(recordDefinition);
    ...
    public static AExplicitOperationDefinition newAExplicitOperationDefinition(
        LexNameToken name, AOperationType type, List<PPattern> parameters,
    ...
    public static AImplicitOperationDefinition newAImplicitOperationDefinition(
        LexNameToken name, List<APatternListTypePair> parameterPatterns,
        APatternTypePair resultPattern, PStm body, ASpecificationStm spec)
      {
        ...
        AOperationType operationType = AstFactory.newAOperationType(
            result.getLocation(),
            ptypes,
            (result.getResult() == null ? AstFactory
                .newAVoidType(name.location) : result.getResult().getType()));
    ...
    public static ASpecificationStm newASpecificationStm(LexLocation location,
        List<AExternalClause> externals, PExp precondition, PExp postcondition,
        List<AErrorCase> errors)
      {
    ...
    public static AExternalClause newAExternalClause(LexToken mode,
        LexNameList names, PType type)
      {
        ...
        result
            .setType((type == null) ? AstFactory.newAUnknownType(names.get(0).location)
                : type);
    ...
    public static AInstanceVariableDefinition newAInstanceVariableDefinition(
        LexNameToken name, PType type, PExp expression)
      {
        ...
        // Definition initialization
        initDefinition(result, Pass.VALUES, name.location, name,
            NameScope.STATE);
    ...
    public static AThreadDefinition newAThreadDefinition(PStm statement)
      {
        ...
        // Definition initialization
        initDefinition(result, Pass.DEFS, statement.getLocation(), null,
            NameScope.GLOBAL);
        
        result.setStatement(statement);
        result.setOperationName(LexNameToken.getThreadName(statement
            .getLocation()));
    ...
    public static AThreadDefinition newAThreadDefinition(LexNameToken opname,
        List<PExp> args)
      {
        ...
        APeriodicStm periodicStatement = AstFactory.newAPeriodicStm(opname,
            args);
    ...
    public static APerSyncDefinition newAPerSyncDefinition(
        LexLocation location, LexNameToken opname, PExp guard)
      {
        APerSyncDefinition result = new APerSyncDefinition();
        // Definition initialization
        initDefinition(result, Pass.DEFS, location,
            opname.getPerName(location), NameScope.GLOBAL);
    ...
    public static AMutexSyncDefinition newAMutexSyncDefinition(
        LexLocation location, LexNameList operations)
      {
    ...
    public static ANamedTraceDefinition newANamedTraceDefinition(
        LexLocation location, List<String> pathname,
    ...
    public static AApplyExpressionTraceCoreDefinition newAApplyExpressionTraceCoreDefinition(
      ...
      {
        return new AApplyExpressionTraceCoreDefinition(stmt.getLocation(),
            stmt, currentModule);
      }
    ...
    public static AFieldExp newAFieldExp(PExp object, LexNameToken field)
      {
        ...
        result.setField(new LexIdentifierToken(field.name, field.old,
            field.location));
    ...
    public static AMkTypeExp newAMkTypeExp(LexNameToken typename,
        List<PExp> args)
      {
    ...
    public static AIsExp newAIsExp(LexLocation location, LexNameToken name,
        PExp test)
      {
    ...
    public static ASetCompSetExp newASetCompSetExp(LexLocation start,
    ...
    public static ASetRangeSetExp newASetRangeSetExp(LexLocation start,
    ...
    public static ASeqCompSeqExp newASeqCompSeqExp(LexLocation start,
    ...
    public static AModuleModules newAModuleModules(LexIdentifierToken name,
        AModuleImports imports, AModuleExports exports, List<PDefinition> defs)
      {
        AModuleModules result = new AModuleModules();
    ...
    public static AAlwaysStm newAAlwaysStm(LexLocation token, PStm always,
        PStm body)
      {
    ...
    public static ACallObjectStm newACallObjectStm(
        PObjectDesignator designator, LexNameToken classname, List<PExp> args)
      {
    ...
    public static AIdentifierObjectDesignator newAIdentifierObjectDesignator(
        LexNameToken name)
      {
        ...
        result.setName(name);
        result
            .setExpression(AstFactory.newAVariableExp(name.getExplicit(true)));
        return result;
      }
    ...
    public static ANewObjectDesignator newANewObjectDesignator(
        LexIdentifierToken classname, List<PExp> args)
      {
        ...
        result.setExpression(AstFactory.newANewExp(classname.location,
            classname, args));
        return result;
      }
    ...
    public static AForAllStm newAForAllStm(LexLocation token, PPattern pattern,
        PExp set, PStm stmt)
      {
    ...
    public static AIfStm newAIfStm(LexLocation token, PExp ifExp,
    ...
    public static ADurationStm newADurationStm(LexLocation location,
    ...
    public static AInMapMapType newAInMapMapType(LexLocation location,
        PType from, PType to)
      {
    ...
    public static AOptionalType newAOptionalType(LexLocation location,
        PType type)
      {
    ...
    public static AInheritedDefinition newAInheritedDefinition(
        LexNameToken localname, PDefinition d)
      {
        ...
        initDefinition(result, d.getPass(), d.getLocation(), localname,
            d.getNameScope());
    ...
    public static AImportedDefinition newAImportedDefinition(
        LexLocation location, PDefinition d)
      {
        AImportedDefinition result = new AImportedDefinition();
        initDefinition(result, Pass.DEFS, location, d.getName(),
            d.getNameScope());
        result.setDef(d);
    ...
    public static ARenamedDefinition newARenamedDefinition(LexNameToken name,
        PDefinition def)
      {
        ...
        initDefinition(result, def.getPass(), name.location, name,
            def.getNameScope());
        result.setDef(def);
    ...
    public static AClassClassDefinition newAClassClassDefinition()
      {
        AClassClassDefinition result = AstFactory.newAClassClassDefinition(
            ...
            new LexNameList(), new Vector<PDefinition>());
    ...
    public static ARecordInvariantType newARecordInvariantType(
        LexLocation location, List<AFieldField> fields)
      {
        ARecordInvariantType result = new ARecordInvariantType();
        initType(result, location);
    ...
    public static AExternalDefinition newAExternalDefinition(PDefinition state,
        LexToken mode)
      {
        ...
        initDefinition(result, Pass.DEFS, state.getLocation(), state.getName(),
            NameScope.STATE);
        
        result.setState(state);
        result.setReadOnly(mode.is(VDMToken.READ));
        result.setOldname(result.getReadOnly() ? null : state.getName()
            .getOldName());
    ...
    public static ALenUnaryExp newALenUnaryExp(LexLocation location, PExp exp)
      {
    ...
    public static AHeadUnaryExp newAHeadUnaryExp(LexLocation location, PExp exp)
      {
    ...
    public static ATailUnaryExp newATailUnaryExp(LexLocation location, PExp exp)
      {
    ...
    public static AUnionType newAUnionType(LexLocation location,
    ...
    public static AMapPattern newAMapPattern(LexLocation location,
